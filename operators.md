...
```
- ans:- 2) i have purchased ...:Mobile, Lappy
...
```
= ans:-1) Multipilcation and Division
...
4. 12
```
- ans:- 2) ERROR : L-Value required syntax d.
...
```
- note:
- a==b i.e 3==2 which is false returns 0
- 0 == 0 true returns 1 then this 1 is assigned to a
- - ans:- 1) 1,2
